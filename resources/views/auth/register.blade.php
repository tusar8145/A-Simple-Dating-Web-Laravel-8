    ...
    <x-slot name="logo"><h1 style="text-align:center">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    <x-jet-label value="{{ __('Select Gender') }}" />


                    <select class="form-select" name="gender">
                        <option disabled selected value="">Select</option>
                        <option @if (old('gender')=='Male') selected @endif value="Male">Male</option>
                        <option  @if (old('Female')=='Male') selected @endif  value="Female">Female</option>
                        <option  @if (old('Others')=='Male') selected @endif  value="Others">Others</option>
                    </select>
